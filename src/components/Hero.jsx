...
export default function Hero({ webs, clientes }) {
  ...
  const email = "matiasespinozadev@gmail.com";
      ...
      <div className="flex-1 flex flex-col gap-8">
        ...
        <div className='flex gap-4'>
          ...
          <button
            ...
            className="relative border-2 border-black rounded-full p-2 bg-white hover:bg-red-600 hover:text-white transition"
            title="Copiar email"
          >
            ...
            {copied && (
              <span className="absolute left-full top-1/2 -translate-y-1/2 ml-6 bg-black text-white text-xs font-bold px-3 py-1 rounded shadow-lg border-2 border-white z-10 whitespace-nowrap">¡Email copiado!</span>
            )}
          </button>
        </div>
      </div>
